...
import { registerSchema, RegisterInput, AuthResponse } from '@travel-diary/contracts';
      ...
      <div className="max-w-md w-full glass-panel p-8 rounded-3xl shadow-soft border border-stone-200">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-stone-600 mt-2">
            Comece a documentar seus passos pelo mundo
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-3.5 px-4 rounded-xl bg-brand-600 hover:bg-brand-700 text-white font-medium text-sm shadow-md transition-all flex items-center justify-center gap-2 disabled:opacity-50 mt-2"
          >
            {isSubmitting ? (
              <>
